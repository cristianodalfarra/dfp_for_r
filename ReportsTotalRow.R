...
reportquery_dfp_tag(year=2016,m_start=m1,m_end=m2,day_start=d1,day_end=d2,device_type="d",dfp_tag="superlead elenco bottom",only_total="yes")
...
treportquery_dfp_unit_like(year=2016,m_start=m1,m_end=m2,day_start=d1,day_end=d2,device_type="d",dfp_unit="%HALF_PAGE%",only_total="yes")
# 
