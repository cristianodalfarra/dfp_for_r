...
# Report ADX - DETTAGLIO -  MOBILE - WBOX 2016
reportquery_dfp_unit_like(year=2016,m_start=m1,m_end=m2,day_start=d1,day_end=d2,device_type="m",dfp_unit="%WBOX%",only_total="yes")# 


# Report ADX - DETTAGLIO -  MOBILE - WBOX 2017
